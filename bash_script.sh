...
<<<<<<< HEAD
sudo su -\-c "R -e \"install.packages( c('Rcpp' ,'bitops' ,'tools' ,'digest' ,'packrat' ,'gtable' ,'lattice' ,'yaml' ,'proto' ,'htmlwidgets' ,'grid' ,'R6' ,'ramazon' ,'RJSONIO' ,'magrittr' ,'scales' ,'htmltools' ,'MASS' ,'mime' ,'xtable' ,'colorspace' ,'httpuv' ,'stringi' ,'RCurl' ,'munsell' ,'stats' ,'graphics' ,'grDevices' ,'utils' ,'datasets' ,'methods' ,'base' ) , repos = 'http://cran.rstudio.com/', dep = TRUE)\""
=======
<<<<<<< Updated upstream
...
=======
sudo su -\-c "R -e \"install.packages( c('Rcpp' ,'git2r' ,'tools' ,'digest' ,'memoise' ,'tibble' ,'gtable' ,'lattice' ,'yaml' ,'curl' ,'withr' ,'httr' ,'htmlwidgets' ,'grid' ,'R6' ,'ramazon' ,'magrittr' ,'scales' ,'htmltools' ,'assertthat' ,'mime' ,'xtable' ,'colorspace' ,'httpuv' ,'stringi' ,'munsell' ,'stats' ,'graphics' ,'grDevices' ,'utils' ,'datasets' ,'methods' ,'base' ) , repos = 'http://cran.rstudio.com/', dep = TRUE)\""
>>>>>>> Stashed changes
>>>>>>> giacomodc/master
echo 'R installed'
