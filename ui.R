...
shinyUI(navbarPage(title="Data Stories from Loading Bays",theme = shinytheme('cerulean'),
        ...
        tabPanel("Case Studies", icon=icon('th'),
                 column(width=12,
                 tabsetPanel(
                   tabPanel('Mall 1',
                            fluidRow(
        ...
        tabPanel("Data Description", icon=icon('file-text-o'),
                 column(width=12,
