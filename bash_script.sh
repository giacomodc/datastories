...
sudo su -\-c "R -e \"install.packages( c('Rcpp' ,'git2r' ,'tools' ,'digest' ,'jsonlite' ,'memoise' ,'gtable' ,'lattice' ,'curl' ,'yaml' ,'proto' ,'httr' ,'withr' ,'htmlwidgets' ,'grid' ,'R6' ,'ramazon' ,'reshape2' ,'magrittr' ,'scales' ,'htmltools' ,'MASS' ,'mime' ,'xtable' ,'colorspace' ,'httpuv' ,'stringi' ,'munsell' ,'stats' ,'graphics' ,'grDevices' ,'utils' ,'datasets' ,'methods' ,'base' ) , repos = 'http://cran.rstudio.com/', dep = TRUE)\""
echo 'R installed'
